...
CREATE TABLE IF NOT EXISTS "public"."diary_journey_entries" (
    ...
    "position_in_journey" integer DEFAULT 0 NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."diary_visit_entries" (
    ...
    "entry_id" "uuid" NOT NULL,
    "position_in_cluster" integer DEFAULT 0 NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."diary_visits" (
    ...
    "user_context" "text",
    "created_at" timestamp with time zone DEFAULT "timezone"('gmt'::"text", "now"()) NOT NULL,
    "visit_type" "text" DEFAULT 'visit'::"text",
    "is_synthetic" boolean DEFAULT false NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."locationsvisitednew" (
    ...
    "possible_primary_types" "text"[] DEFAULT '{}'::"text"[]
);
...
COMMENT ON COLUMN "public"."locationsvisitednew"."possible_primary_types" IS 'Stores an array of next most popular (up to 4 more) primaryType strings from the Google Places API, excluding the first result, already stored.';
...
COMMENT ON COLUMN "public"."places"."hashed_google_id" IS 'sha-256 hashed version of the places.id';



COMMENT ON COLUMN "public"."places"."place_id" IS 'Sequential listing of places visited';
...
ALTER TABLE ONLY "public"."diaries"
    ADD CONSTRAINT "diaries_device_date_unique" UNIQUE ("deviceid", "diary_date");
...
ALTER TABLE ONLY "public"."diary_journey_entries"
    ADD CONSTRAINT "diary_journey_entries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."diary_journey_entries"
    ADD CONSTRAINT "diary_journey_entries_unique" UNIQUE ("diary_journey_id", "entry_id");



ALTER TABLE ONLY "public"."diary_journeys"
    ADD CONSTRAINT "diary_journeys_diary_journey_unique" UNIQUE ("diary_id", "journey_id");



ALTER TABLE ONLY "public"."diary_journeys"
    ADD CONSTRAINT "diary_journeys_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."diary_visit_entries"
    ADD CONSTRAINT "diary_visit_entries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."diary_visit_entries"
    ADD CONSTRAINT "diary_visit_entries_unique" UNIQUE ("diary_visit_id", "entry_id");



ALTER TABLE ONLY "public"."diary_visits"
    ADD CONSTRAINT "diary_visits_diary_visit_unique" UNIQUE ("diary_id", "visit_id");



ALTER TABLE ONLY "public"."diary_visits"
    ADD CONSTRAINT "diary_visits_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_locationsvisitednew_secondary_types" ON "public"."locationsvisitednew" USING "gin" ("possible_primary_types");
...
ALTER TABLE ONLY "public"."diary_journey_entries"
    ADD CONSTRAINT "diary_journey_entries_entry_fkey" FOREIGN KEY ("entry_id") REFERENCES "public"."locationsvisitednew"("entryid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."diary_journey_entries"
    ADD CONSTRAINT "diary_journey_entries_journey_fkey" FOREIGN KEY ("diary_journey_id") REFERENCES "public"."diary_journeys"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."diary_journeys"
    ADD CONSTRAINT "diary_journeys_diary_id_fkey" FOREIGN KEY ("diary_id") REFERENCES "public"."diaries"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."diary_visit_entries"
    ADD CONSTRAINT "diary_visit_entries_entry_fkey" FOREIGN KEY ("entry_id") REFERENCES "public"."locationsvisitednew"("entryid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."diary_visit_entries"
    ADD CONSTRAINT "diary_visit_entries_visit_fkey" FOREIGN KEY ("diary_visit_id") REFERENCES "public"."diary_visits"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."diary_visits"
    ADD CONSTRAINT "diary_visits_diary_id_fkey" FOREIGN KEY ("diary_id") REFERENCES "public"."diaries"("id") ON DELETE CASCADE;



CREATE POLICY "Allow anonymous inserts" ON "public"."diaries" FOR INSERT TO "authenticated", "anon", "service_role" WITH CHECK (true);



CREATE POLICY "Allow anonymous inserts" ON "public"."diary_journey_entries" FOR INSERT TO "authenticated", "anon", "service_role" WITH CHECK (true);



CREATE POLICY "Allow anonymous inserts" ON "public"."diary_journeys" FOR INSERT TO "authenticated", "anon", "service_role" WITH CHECK (true);



CREATE POLICY "Allow anonymous inserts" ON "public"."diary_visit_entries" FOR INSERT TO "authenticated", "anon", "service_role" WITH CHECK (true);



CREATE POLICY "Allow anonymous inserts" ON "public"."diary_visits" FOR INSERT TO "authenticated", "anon", "service_role" WITH CHECK (true);
...
CREATE POLICY "Allow anonymous selects" ON "public"."diaries" FOR SELECT TO "authenticated", "anon", "service_role" USING (true);



CREATE POLICY "Allow anonymous selects" ON "public"."diary_journey_entries" FOR SELECT TO "authenticated", "anon", "service_role" USING (true);



CREATE POLICY "Allow anonymous selects" ON "public"."diary_journeys" FOR SELECT TO "authenticated", "anon", "service_role" USING (true);



CREATE POLICY "Allow anonymous selects" ON "public"."diary_visit_entries" FOR SELECT TO "authenticated", "anon", "service_role" USING (true);



CREATE POLICY "Allow anonymous selects" ON "public"."diary_visits" FOR SELECT TO "authenticated", "anon", "service_role" USING (true);



CREATE POLICY "Allow anonymous updates" ON "public"."diaries" FOR UPDATE TO "authenticated", "anon", "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Allow anonymous updates" ON "public"."diary_journeys" FOR UPDATE TO "authenticated", "anon", "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Allow anonymous updates" ON "public"."diary_visits" FOR UPDATE TO "authenticated", "anon", "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Write to place table" ON "public"."places" FOR INSERT WITH CHECK (true);
...
GRANT ALL ON SEQUENCE "public"."places_place_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."places_place_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."places_place_id_seq" TO "service_role";
